    ...
    <body>
        ...
        <div class="container">
            <div class="jumbotron" style="margin-top: 80px;">
                ...
                <h3>A carefully gathered getup is worthless if the elements don't fit.</h3>
                <h3> When wanting to look your best, fit is king.</h3>
            </div>
            ...
            <div id="Shirts" class="row text-center">
                <div class="col-md-3 col-sm-6 thumbnail">
                    <img src="image/auzfs.jpg" alt="shirt"/>
                    <div class="caption">
                        <h3>White</h3>
                        <p>Price:Rs.999.00</p>
                        <?php if (!isset($_SESSION['email'])) { ?>
                ...
                <div class="col-md-3 col-sm-6 thumbnail">
                    <img src="image/armani.jpg" alt="shirt"/>
                    <div class="caption">
                        <h3>Black</h3>
                        <p>Price:Rs.999.00</p>
                        <?php if (!isset($_SESSION['email'])) { ?>
                ...
                <div class="col-md-3 col-sm-6 thumbnail">
                    <img src="image/lee_cooper.jpg" alt="shirt"/>
                    <div class="caption">
                        <h3>Blue</h3>
                        <p>Price:Rs.999.00</p>
                        <?php if (!isset($_SESSION['email'])) { ?>
                ...
                <div class="col-md-3 col-sm-6 thumbnail">
                    <img src="image/suitup.jpg" alt="shirt"/>
                    <div class="caption">
                        <h3>Red</h3>
                        <p>Price:Rs.999.00</p>
                        <?php if (!isset($_SESSION['email'])) { ?>
